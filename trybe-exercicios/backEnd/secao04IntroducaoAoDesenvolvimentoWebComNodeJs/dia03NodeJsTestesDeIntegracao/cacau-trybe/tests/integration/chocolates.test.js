...
describe('Testando a API Cacau Trybe', function () {
  ...
  describe('Usando o método GET em /chocolates/search para pesquisar chocolates por nome', function () {
    it('Retornar os chocolates que contém o termo pesquisado', async function () {
      const output = [
        {
          "id": 3,
          "name": "Mon Chéri",
    ...
    it('Retornar um array vazio quando não há chocolates que contenham o termo pesquisado', async function () {
      const response = await chai
        .request(app)
        .get('/chocolates/search')
        .query({ name: 'ZZZ' });
  ...
  describe('Usando o método PUT em /chocolates/:id para atualizar um chocolate', function () {
    it('Atualizar um chocolate que existe na base de dados', async function () {
      const newValues = {
