-- 1 Usando o IF na tabela sakila.film, exiba o id do filme, o título e uma coluna extra
-- chamada ‘conheço o filme?’, em que deve-se avaliar se o nome do filme é ‘ACE GOLDFINGER‘.
...
SELECT
    film_id,
    title,
    IF(title = 'ACE GOLDFINGER', 'Já assisti a esse filme', 'Não conheço o filme') AS Status
FROM sakila.film;
