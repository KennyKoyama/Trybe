...
Este repositório contém todas as atividades de aprendizagem desenvolvidas por _[KennyKoyama](LinkDoSeuLinkedinAqui)_ enquanto estudava na [Trybe](https://www.betrybe.com/) :rocket:
...
- [ ] 6-3: _RTL - Testanto React Router_
...
- [ ] 2-1: _ORM - Interface da aplicação com o banco de dados_
- [ ] 2-2: _ORM - Associations 1:1 e 1:N_
- [ ] 2-3: _ORM - Associations N:N e Transactions_
- [ ] 2-4: _JWT - (JSON Web Token)_
- [ ] 2-5: _Projeto - API de Blogs_
