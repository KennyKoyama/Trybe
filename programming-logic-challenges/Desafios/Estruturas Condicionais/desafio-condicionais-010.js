...
function droneDelivery(heightBox, widthBox, depthBox, heightWindow, widthWindow, depthWindow){
  ...
  let checkHeight = heightBox < heightWindow;
  let checkWidth = widthBox < widthWindow;
  let checkDepth = depthBox < depthWindow;

  if(checkHeight && checkDepth || checkWidth && checkDepth) return 'É possível realizar a entrega.';
