...
function studentSituation(studentNote){
  ...
  if(studentNote <= 10) return 'PÉSSIMO';
  if(studentNote >= 11 && studentNote <= 30) return 'RUIM';
  if(studentNote >= 31 && studentNote <= 50) return 'REGULAR';
  if(studentNote >= 51 && studentNote <= 70) return 'MEDIANO';
  if(studentNote >= 71 && studentNote <= 90) return 'ÓTIMO';
