...
function cardsGame(maraCard1, maraCard2, saraCard1, saraCard2){
  ...
  let maraScore = maraCard1 === maraCard2 ? (maraCard1 + maraCard2) * 2
                : maraCard1 === (maraCard2 - 1) || maraCard1 === (maraCard2 + 1) ? (maraCard1 + maraCard2) * 3
                : (maraCard1 + maraCard2);

  let saraScore = saraCard1 === saraCard2 ? (saraCard1 + saraCard2) * 2
                : saraCard1 === (saraCard2 - 1) || saraCard1 === (saraCard2 + 1)? (saraCard1 + saraCard2) * 3
                : (saraCard1 + saraCard2);

  let result = maraScore > saraScore ? `Mara venceu com ${maraScore} pontos`
              : maraScore < saraScore ? `Sara venceu com ${saraScore} pontos`
              : 'O jogo empatou';
